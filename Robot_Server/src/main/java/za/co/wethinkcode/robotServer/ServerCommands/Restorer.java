...
import static za.co.wethinkcode.robotServer.ServerCommands.Saver.worldNameAlreadyExistsInDatabase;
...
//                System.out.println("OLDS: \nWord Size: " + worldSize + "\n Obstacle at (" + obsticleXCoord + "," + obstacleYCoord + ")");
                if(worldNameAlreadyExistsInDatabase(world_name)) {
                    while (rs.next()) { // something is wrong here
                        ...
                        System.out.println("\nCongratulations! WORLD of: \n- size " + worldSize + "x" + worldSize +
                                " and \n- obstacles at (" + obsticleXCoord + "," + obstacleYCoord + ") " +

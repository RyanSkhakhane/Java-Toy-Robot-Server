...
//        System.out.println(response1.get("data").get("message").asText());
    ...
    void canLaunchAnotherRobot() {
        ...
        String position1 = firstRobotResponse.get("data").get("position").toString();

        JsonNode response2 = null;
        boolean world_full = false;
        int count = 0;
        ...
        String request2 = "{" +
                ...
                "  \"arguments\": [\"shooter\",\"5\",\"5\"]" +
                "}";
        response2 = serverClient.sendRequest(request2); // {"result":"OK","data":{"visibility":1,"position":[0,0],"objects":[]},"state":{"position":[0,0],"direction":"NORTH","shields":0,"shots":0,"status":"TODO"}}
        String position2 = response2.get("data").get("position").toString();
